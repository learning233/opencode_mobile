...
/// Returns the control-code byte string for `Ctrl+char`, or `null` when the
/// character cannot be combined with Ctrl.
///
/// - a-z / A-Z -> `\x01`..`\x1a`
/// - `@`, `[`, `\`, `]`, `^`, `_` -> `\x00`..`\x1f`
/// - space -> `\x00`
///
/// For example, `ctrlCodeForInsert('a')` returns `\x01` and
/// `ctrlCodeForInsert(' ')` returns `\x00`.
String? ctrlCodeForInsert(String text) {
  if (text == ' ') return String.fromCharCode(0);
