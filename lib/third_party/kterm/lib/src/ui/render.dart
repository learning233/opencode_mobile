...
typedef EditableRectCallback = void Function(
    Rect rect, Rect caretRect, Matrix4 transform);
...
class RenderTerminal extends RenderBox with RelayoutWhenSystemFontsChangeMixin {
  ...
  /// Selects characters starting from a specific [fromPosition] cell offset to a pixel [to] offset.
  ...
  void _notifyEditableRect() {
    ...
    _onEditableRect?.call(rect, caretRect, transform);
  }
  ...
  void _paint(PaintingContext context, Offset offset) {
    ...
    if (_controller.isSearching && _controller.hasSearchResults) {
      _paintSearchHighlights(canvas, effectFirstLine, effectLastLine);
    }
  }
  ...
  void _paintSearchHighlights(Canvas canvas, int firstLine, int lastLine) {
