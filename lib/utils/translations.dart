...
class Messages extends Translations {
  ...
  static const Map<String, String> _zhCN = {
    ...
    LocaleKeys.e2bPauseSandbox: '休眠',
    LocaleKeys.e2bResumeSandbox: '唤醒',
    ...
    LocaleKeys.e2bSandboxStatusPaused: '🟡 已休眠',
    ...
    LocaleKeys.e2bSandboxPausedSuccess: '沙盒 @id 已休眠',
    LocaleKeys.e2bSandboxPauseFailed: '休眠沙盒失败: @error',
