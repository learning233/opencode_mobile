...
void main() {
  ...
  testWidgets('DesktopSessionTabBar displays session titles and handles selection', (tester) async {
  ...
  testWidgets('DesktopSessionTabBar differentiates width by title length before overflow', (tester) async {
    debugDefaultTargetPlatformOverride = TargetPlatform.windows;
    try {
      tester.view.physicalSize = const Size(1280, 800);
      tester.view.devicePixelRatio = 1.0;
      ...
      final tabSizedBoxes = tester.widgetList<SizedBox>(
        find.descendant(
          of: find.byType(DesktopSessionTabBar),
          matching: find.byType(SizedBox),
        ),
      ).where((box) => box.width != null && box.width! > 32.0).toList();
  ...
  testWidgets('DesktopSessionTabBar adapts and shrinks tab widths as tabs increase', (tester) async {
    debugDefaultTargetPlatformOverride = TargetPlatform.windows;
    try {
  ...
  testWidgets('HomeAppBar includes bottom height and renders bottom on desktop', (tester) async {
    debugDefaultTargetPlatformOverride = TargetPlatform.windows;
    try {
      final sessionCtrl = Get.put(SessionController());
  ...
  testWidgets('DesktopSessionTabBar opens context menu on right click', (tester) async {
    debugDefaultTargetPlatformOverride = TargetPlatform.windows;
    try {
      tester.view.physicalSize = const Size(1280, 800);
      tester.view.devicePixelRatio = 1.0;
  ...
  testWidgets('DesktopSessionTabBar displays close button on hover even for short titles', (tester) async {
    debugDefaultTargetPlatformOverride = TargetPlatform.windows;
    try {
      tester.view.physicalSize = const Size(1280, 800);
      tester.view.devicePixelRatio = 1.0;
